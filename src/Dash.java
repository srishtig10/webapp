...
public class Dash extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//out.println("<HEAD><TITLE>Employee Login</TITLE><body>");
		out.println("<html>"+"<head>"+"<meta charset="+"ISO-8859-1"+">"+"<title> EMPLOYEE LOGIN </title><script src='https://www.google.com/recaptcha/api.js'></script>"+"<link rel="+"stylesheet"+" type="+"text/css"+" href="+"design.css"+">"+
